			...
			switch(args[0].toLowerCase()){
				case "on":
					if(!(sender instanceof Player)){
						...
						sender.sendMessage(TextFormat.RED + "[ShowInfo] Infomation already displayed");
					}else{
						this.plugin.getOffPlayersConfig().remove(sender.getName().toLowerCase());
						sender.sendMessage(TextFormat.AQUA + "[ShowInfo] Now infomation is displayed.");
					}
					break;
				case "off":
					if(!(sender instanceof Player)){
						...
						sender.sendMessage(TextFormat.RED + "[ShowInfo] Infomation already not displayed");
					}else{
						this.plugin.getOffPlayersConfig().set(sender.getName().toLowerCase(), true);
						sender.sendMessage(TextFormat.AQUA + "[ShowInfo] Now infomation is not displayed.");
					}
					break;
				case "start":
					if(!this.plugin.isTaskStop()){
						...
						sender.sendMessage(TextFormat.AQUA + "[ShowInfo] Now infomation is displayed to players");
					}
					break;
				case "stop":
					if(this.plugin.isTaskStop()){
						...
						sender.sendMessage(TextFormat.AQUA + "[ShowInfo] Now infomation is not displayed to players");
					}
					break;
				case "push":
